...
private let logger = Logger(subsystem: "com.youngpilot.Steneo", category: "SystemAudio")
...
final class SystemAudioService {
    ...
    private static let scriptQueue = DispatchQueue(label: "com.youngpilot.Steneo.applescript", qos: .userInitiated)
