...
private let logger = Logger(subsystem: "com.youngpilot.Steneo", category: "Output")
...
final class OutputService {
    ...
    /// The last non-Steneo app that was frontmost
    ...
    private static let typingQueue = DispatchQueue(label: "com.youngpilot.Steneo.typing", qos: .userInitiated)
